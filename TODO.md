...
1. **Ortholog data validation** — CT119 (CT-D) does not show reciprocal orthologs when navigated to; likely a row direction issue in orthologs table (gene_id_a/gene_id_b pairing); investigate query and/or data
