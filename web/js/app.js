...
import { renderHome } from './views/home.js?v=6';
import { renderGenomes } from './views/genomes.js?v=6';
import { renderMutants } from './views/mutants.js?v=6';
import { renderPipeline } from './views/pipeline.js?v=6';
