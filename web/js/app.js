...
import { renderHome } from './views/home.js?v=9';
import { renderGenomes } from './views/genomes.js?v=9';
import { renderMutants } from './views/mutants.js?v=9';
import { renderPipeline } from './views/pipeline.js?v=9';
